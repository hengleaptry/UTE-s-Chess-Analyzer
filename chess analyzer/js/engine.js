...
function createWorkerViaImportScripts(jsUrl, wasmUrl) {
...
async function initStockfish() {
  ...
  try {
    ...
    const worker = createWorkerViaImportScripts(MODERN_ENGINE_JS, MODERN_ENGINE_WASM);
    ...
    try {
      ...
      const legacyWorker = createWorkerViaImportScripts(LEGACY_ENGINE_JS, null);
